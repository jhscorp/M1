...
import 'package:m1/restaurant/repository/restaurant_repository.dart';
...
class RestaurantStateNotifier
  ...
  void getDetail({
    ...
    // 요청 id: 10
    // list.where((e) => e.id == 10)) 데이터 없음 --> 그래서 에러가 나는 것임
    ...
    if(pState.data.where((e) => e.id == id).isEmpty){
      ...
      // [RestaurantMode(1), RestaurantModel(2), RestaurantMode(3)]
